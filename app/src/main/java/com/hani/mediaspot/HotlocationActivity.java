...
public class HotlocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotlocation);
        ...
        fab.setOnClickListener(v -> {
            if (!spotList.isEmpty()) {
                Intent intent = new Intent(HotlocationActivity.this, MapActivity.class);
    ...
    private void loadSpots(@Nullable String locationType, String keyword) {
        isLoading = true;
        Retrofit retrofit = NetworkClient.getRetrofitClient(this);
        FilterApi filterApi = retrofit.create(FilterApi.class);
        Call<FilterRes> call = filterApi.getHotLocation(currentPage, pageSize, currentLocationType,"");
    ...
    private void searchSpot(@Nullable String locationType, String keyword) {
        isLoading = true;
        Retrofit retrofit = NetworkClient.getRetrofitClient(this);
        FilterApi filterApi = retrofit.create(FilterApi.class);
        Call<FilterRes> call = filterApi.getHotLocation(currentPage, pageSize, currentLocationType,currentKeyword);
    ...
    private void performActionBasedOnKeyword( String keyword, String locationType) {
        if (currentKeyword != null && !currentKeyword.isEmpty()) {
            searchSpot(currentLocationType, currentKeyword);
        } else {
            loadSpots(currentLocationType, currentKeyword);
        }
    }
